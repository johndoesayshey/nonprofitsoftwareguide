---
product: "iWave (Kindsight)"
slug: iwave
category: prospect-research
targetQuery: "iwave alternatives"
lastVerified: 2026-08-03
incumbentSlug: kindsight
reasonsToLeave:
  - reason: "It's an annual contract at four figures."
    detail: "Reported entry is around $4,150/yr for one user and roughly 1,500 screens; the Professional tier is reported near $5,350/yr for three users and about 5,000 screens. That's a commitment before you know whether the output changes anyone's behaviour."
  ...
  - reason: "Scores don't create a portfolio."
    detail: "The output is a ranked list. Someone has to turn it into visits. Shops that subscribe without a named major-gifts owner renew a product nobody opened."
  - reason: "You may only need one screen."
    detail: "Pre-campaign feasibility is a project, not an ongoing need. Paying annually for a one-time job is the most common way this category is over-bought."
picks:
...
Wealth screening is the most over-bought category in fundraising software. The tools are good; the problem is that a ranked list of capacity scores does nothing on its own, and the annual contract starts whether or not anyone works it.

## The test before you shop

Ask who, by name, will make the visits. If the answer isn't a specific person with time on their calendar, no screening product on the market will pay for itself, and the cheaper move is to hand-research your top 25 prospects and see whether that produces meetings.

Our 2026 survey of 100 U.S. fundraising professionals found that 95% of shops under $250K raised report spending $0 on wealth screening. Mean spend in that segment is $45 a year. At $250K–$1M it's $1,319, at $1M–$5M it's $4,135, and at $5M+ it's $17,320. The category effectively starts at $1M raised. If you're below that and looking at a $4,000 contract, the survey data is the argument against it.
