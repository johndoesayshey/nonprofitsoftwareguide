---
title: "Running a screening bake-off: the test-file method"
description: "Every wealth screening vendor is quote-only, which means your price reflects the negotiation. Here is how to compare them on output rather than feature lists, and get a real quote."
publishDate: 2026-08-03
updatedDate: 2026-08-03
stack: 1m-5m
category: prospect-research
targetQuery: "compare wealth screening vendors"
platformsMentioned: [kindsight, donorsearch, wealthengine]
affiliateSlugs: [kindsight, donorsearch]
faq:
  - q: "Will wealth screening vendors screen a sample file for free?"
    a: "Most will during the sales process, and you should ask. A vendor unwilling to demonstrate output on your own data before you commit to a four-figure annual contract is telling you something worth hearing."
  - q: "How large should a test file be?"
    a: "Fifty to a hundred constituents whose capacity you can independently verify. Large enough that patterns show, small enough that you can judge every result personally. A bigger file just means more results you cannot check."
  - q: "Should we tell vendors we are testing others?"
    a: "Yes. Every product in this category is quoted per organization with no public rate card, which means your price reflects the negotiation. A competing bid is the entirety of your leverage, and it works far better before you sign than at renewal."
  - q: "What if two vendors disagree about the same person?"
    a: "That is the most useful result in the exercise. Ask each to explain how they arrived at their rating. The one that can explain it is the one your gift officers will trust on the names you cannot verify."
draft: false
---
