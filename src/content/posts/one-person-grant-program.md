---
title: "Building a grant pipeline when you are the only writer"
description: "A one-person grant program fails on deadlines, not on writing. The tracking system, the realistic application volume, and what to cut when the calendar collapses."
