---
title: "Hand-researching your top 25 prospects for free"
description: "Before you spend $4,000 on wealth screening, do this. The public sources, the order to work them in, and what a capacity estimate you built yourself is actually worth."
...
faq:
  - q: "Can you do prospect research without paid software?"
    a: "Yes, for a small list. Public 990s, property records, corporate filings and published donor listings will get you a defensible capacity estimate for 25 people. What you cannot do by hand is screen a file of 10,000; that is the point at which software earns its price."
  - q: "Is it ethical to research donors?"
    a: "Researching public information about someone's capacity to give is standard practice in fundraising and is covered by professional ethics guidance in the field. The lines that matter are using only appropriate sources, storing findings securely, restricting access, and not recording things that are not relevant to the relationship."
  - q: "What is the single most useful free source?"
    a: "Other organizations' donor listings, annual reports, gala programs, capital campaign plaques. They show demonstrated giving at a stated level, which predicts future giving better than any wealth indicator."
  - q: "When should we stop doing this by hand?"
    a: "When the month you spend keeping up stops being enough. If your prospect list has outgrown what one person can maintain, or you need to rank a whole file rather than a shortlist, that is a real case for a screening subscription."
draft: false
---
