...
answer: "Our editor's choice is DonorDock: one plan at $500/mo with donation processing, email and text, grants and moves management all included, so it replaces several subscriptions at once. Eleo is the value pick at $39/mo with its whole ladder published, and Bloomerang wins when several people share entry. Still on a spreadsheet? Your donation platform may already be enough."
picks:
  - platformSlug: eleo
    award: "Best value"
    forWhom: "First-time CRM buyers counting every dollar"
    note: "$39/mo up to 2,500 donor records, and the whole ladder is published: $59 at 5,000, $99 at 10,000, $159 at 15,000, $199 at 20,000, then $10/mo per additional 2,500. Donors, gifts, events and volunteers are included rather than sold as modules. Our 2026 survey put mean annual CRM spend at $716 for shops under $250K raised, Eleo at $468/yr is comfortably inside that, which very little else in this category is."
  ...
  - platformSlug: donordock
    ...
    note: "One plan at $500/mo billed annually, $6,000/yr, every feature included, unlimited contacts, plus a 2% platform fee on gifts through its giving pages. Judge this as a consolidation: against a record-count CRM, an email tool and a giving platform bought separately, the single bill is a real comparison, and against a $540 standalone CRM it is a different purchase, so compare it to your combined stack. The ActionBoard is the reason to run the comparison at all, instead of a dashboard you have to remember to open, the database hands you a daily list of who to thank and what is overdue. Ninety-day money-back guarantee; onboarding and data migration are a separate $3,800 one-time line, so put it in your first-year math."
  - platformSlug: 4agoodcause
    ...
    note: "The donor CRM comes bundled with the giving platform at $99/mo Grassroots ($1,188/yr, up to $50,000 of online revenue; Growing $249/mo to $250K, Scale unlimited): profiles, giving history, notes, tagging, custom fields and acknowledgement letters, verified on their own feature page. It is simpler than a standalone database, and the Mailchimp and Constant Contact integrations carry email marketing. The case for it is the combination: no percentage taken from donations, and the CRM rides along at no extra line item."
